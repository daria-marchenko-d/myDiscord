...
//         GtkWidget *dialog = gtk_alert_dialog_new(GTK_WINDOW(window), GTK_DIALOG_DESTROY_WITH_PARENT,
...
//             GtkWidget *dialog = gtk_alert_dialog_new(GTK_WINDOW(parent_window), GTK_DIALOG_DESTROY_WITH_PARENT,
//                                                      GTK_MESSAGE_ERROR, GTK_BUTTONS_CLOSE,
